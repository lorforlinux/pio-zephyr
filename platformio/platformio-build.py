...
if project_settings.get("CONFIG_CODE_DATA_RELOCATION", ""):
    ...
    env.Depends(offset_header_file, relocation_files)
...
env.Depends(stage0_ldscript, relocation_files)
env.Depends(stage0_ldscript, offset_header_file)
env.Depends(stage1_ldscript, offset_header_file)
